...
## Predicting Distance
In this hypothetical example, we will use the data found in the [Distance Case Study](../visualizations/case_study_dist.md) please go to that page to view and learn more about the data. 
...
::::{tab-set}
:::{tab-item} Data
Please look at the [Distance Case Study](../visualizations/case_study_dist.md). 
...
![All Distance Data](../visualizations/images/fi_dist_scatter.png)  
...
![Linear Regressor Predictions](../visualizations/images/fi_linear_predictions.png)
![Decision Tree Regressor Predictions](../visualizations/images/fi_dt_predictions.png)  
