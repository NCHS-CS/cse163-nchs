...
![Predictable Data](../visualizations/images/class_nba_data.png) ![Predictable Data](../visualizations/images/class_nba_data_in_nba.png)
:::
:::{tab-item} Randomized
...
![Randomized Data](../visualizations/images/class_nba_rand_data.png) ![Randomized Data](../visualizations/images/class_nba_rand_data_in_nba.png)
:::
::::
## The code
...
![Simple Data Predictions](../visualizations/images/class_nba_results.png)  
...
:::{important} Make your prediction
...
![No Gender Model Results](../visualizations/images/class_no_gender.png)    
...
#### Fairness
First, you should know that fairness is covered in [Lesson 28](../lectures/fairness.ipynb). What is especially important is to know the definitions of fairness and how we can discuss fairness scientifically once we define it.
...
::::{tab-set}
:::{tab-item} Female
![Female Fairness](../visualizations/images/class_female_fairness.png)
:::
:::{tab-item} Male
![Male Fairness](../visualizations/images/class_male_fairness.png)  
:::
::::
#### Summary
...
![Random #1 Predictions](../visualizations/images/class_nba_rand_results.png)
...
![Random #2 Predictions](../visualizations/images/class_nba_rand_results_2.png)
...
![Random #3 Predictions](../visualizations/images/class_nba_rand_results_3.png)
...
This image of the Decision Tree is small and hard to read. The blue boxes predict NBA while the others predict not. You can see that virtually every path leads to False (not in NBA). Seems like a pretty dumb tree to me.  

![Decision Tree for NBA](../visualizations/images/class_nba_rand_model_3.png)   
...
![NBA Model](../visualizations/images/fi_model_nba.png)
