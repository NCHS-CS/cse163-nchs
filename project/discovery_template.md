...
:::{seealso}
Review the tips and details in the [discovery overview](../project/discovery.md)
:::
...
See the [Dataset Example (TBD)](../tbd.md) for more details.

---

### [Challenge goals](../project/discovery_challenges.md)
