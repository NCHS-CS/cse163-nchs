...
* Explore the predictions made by the model to either:   
   * provide insight into how the model makes its predictions. You can look at [Machine Learning -> Regression-Distance Study](../machine-learning/regression-distance.md) Look at how the Model Graphs provide clear insight into how the model makes predictions.
